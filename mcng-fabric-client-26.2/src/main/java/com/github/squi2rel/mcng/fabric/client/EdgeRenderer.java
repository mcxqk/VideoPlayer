...
public final class EdgeRenderer {
	...
	private static void drawStraight(GuiGraphicsExtractor context, int startX, int startY, int endX, int endY, int startColor, int endColor) {
	...
	private static void drawGradientPolyline(GuiGraphicsExtractor context, List<Point> points, int startColor, int endColor) {
	...
	private static void drawGradientOrthogonalPolyline(GuiGraphicsExtractor context, List<Point> points, int startColor, int endColor) {
		double totalLength = 0.0;
		for (int index = 1; index < points.size(); index++) {
			totalLength += distance(points.get(index - 1), points.get(index));
		}
