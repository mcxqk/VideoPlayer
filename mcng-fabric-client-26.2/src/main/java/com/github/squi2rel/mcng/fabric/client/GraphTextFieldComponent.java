...
final class GraphTextFieldComponent {
	...
	void render(GuiGraphicsExtractor context, Font textRenderer, GraphEditorTheme theme, GraphEditorUiConfig uiConfig) {
		...
		try {
			if (!state.text().isEmpty()) {
				...
				context.text(textRenderer, placeholder, bounds.x() + GraphTextInputRenderer.CONTENT_PADDING_X, baselineY, theme.secondaryTextColor(), false);
