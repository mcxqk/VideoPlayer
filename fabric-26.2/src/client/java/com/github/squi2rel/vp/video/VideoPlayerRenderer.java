...
final class VideoPlayerRenderer {
    ...
    static void draw(IVideoPlayer player, PoseStack matrices, WorldRenderBatch consumers, ClientVideoScreen target) {
    ...
    static void drawTexture(int textureId, int textureWidth, int textureHeight,
                            PoseStack matrices, WorldRenderBatch consumers, ClientVideoScreen target) {
