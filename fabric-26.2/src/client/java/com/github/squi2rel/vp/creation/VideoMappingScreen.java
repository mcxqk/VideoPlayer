...
public class VideoMappingScreen extends Screen implements ServerStateScreen {
    ...
    private void drawPreview3dTexture(GuiGraphicsExtractor context, ScreenGeometry geometry, ArrayList<PreviewVertex3d> projected) {
    ...
    private void drawPreview3dOutline(GuiGraphicsExtractor context, ScreenGeometry geometry, ArrayList<PreviewVertex3d> projected) {
