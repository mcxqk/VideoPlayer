...
public final class ClientDanmakuRenderer {
    ...
    public static void draw(PoseStack matrices, WorldRenderBatch consumers, ClientVideoScreen target) {
    ...
    public static void drawSubtitles(PoseStack matrices, WorldRenderBatch consumers, ClientVideoScreen target) {
    ...
    public static void drawPreview(GuiGraphicsExtractor context, ClientVideoScreen target, int x, int y, int width, int height) {
        ...
        try {
            GuiTextBatch batch = new GuiTextBatch(new ScreenRectangle(x, y, width, height));
    ...
    public static void drawSubtitlePreview(GuiGraphicsExtractor context, ClientVideoScreen target, int x, int y, int width, int height) {
    ...
    private static void collectPreviewItem(GuiGraphicsExtractor context, GuiTextBatch batch,
    ...
    private static void drawPreviewSubtitleBackground(GuiGraphicsExtractor context, ClientDanmakuController.RenderableDanmaku item,
    ...
    private static void drawDanmakuItems(WorldRenderBatch consumers, RenderContext context, ClientVideoScreen target,
    ...
    private static void drawSubtitleItems(WorldRenderBatch consumers, RenderContext context, ClientVideoScreen target,
                                          List<ClientDanmakuController.RenderableDanmaku> items) {
    ...
    private static void drawSubtitleBackgrounds(WorldRenderBatch consumers, RenderContext context, ClientVideoScreen target,
                                                List<ClientDanmakuController.RenderableDanmaku> items) {
    ...
    private static final class GuiTextBatch {
        ...
        private void submit(GuiGraphicsExtractor context) {
            ...
            for (Map.Entry<GuiTextBatchKey, ArrayList<GuiGlyphVertex>> entry : verticesByBatch.entrySet()) {
                ...
                ((DrawContextAccessor) context).videoplayer$getState().addGuiElement(new GuiTextBatchRenderState(
    ...
    private static final class WorldTextBatch {
        ...
        private void submit(WorldRenderBatch output) {
