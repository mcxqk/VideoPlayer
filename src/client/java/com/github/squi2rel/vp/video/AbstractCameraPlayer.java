...
public abstract class AbstractCameraPlayer extends AbstractScreenPlayer implements MetaListener {
    ...
    @Override
    public void init() {
        framebuffer1 = new TextureTarget("VideoPlayer camera 1", targetWidth, targetHeight, true);
        framebuffer2 = new TextureTarget("VideoPlayer camera 2", targetWidth, targetHeight, true);
